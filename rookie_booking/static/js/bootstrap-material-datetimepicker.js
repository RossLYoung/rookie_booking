(function($, moment)
{
	...
	Plugin.prototype = 
	{
								...
								'<div class="dtp-content">' +
									'<div class="dtp-date-view">' +
										...
										'<div class="dtp-picker">' +													
											'<div class="dtp-picker-booking_calendar"></div>' +
		...
		initDate: function(d)
		{
			...
			this.$dtpElement.find('.dtp-picker-booking_calendar').removeClass('hidden');
			...
			if(typeof(_calendar.week) !== 'undefined' && typeof(_calendar.days) !== 'undefined')
			{
				...
				this.$dtpElement.find('.dtp-picker-booking_calendar').html(_template);
		...
		initHours: function()
		{
			...
			this.$dtpElement.find('.dtp-picker-booking_calendar').addClass('hidden');
